...
export function ComparisonSection() {
  return (
    <section id="comparison" className="relative py-12 sm:py-28 border-t border-white/5 bg-gradient-to-b from-[#121212] via-[#1a2130] to-[#121212] overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-sky-900/12 via-[#121212] to-[#121212] pointer-events-none" />

      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6">
        <div className="text-center max-w-3xl mx-auto mb-10 sm:mb-20">
          <span className="inline-flex items-center gap-2 px-3.5 py-1.5 sm:px-4 sm:py-2 rounded-full bg-sky-500/10 border border-sky-400/20 text-sky-300 text-[11px] sm:text-xs font-bold mb-4 sm:mb-6 shadow-md">
          ...
          <h2 className="text-2xl sm:text-5xl lg:text-6xl font-black font-display text-white mb-4 sm:mb-6 tracking-tight">
            لماذا يتحول الجميع إلى <span className="bg-clip-text text-transparent bg-gradient-to-l from-sky-400 to-brand-300 drop-shadow-[0_1px_8px_rgba(56,189,248,0.18)]">Grido Studio</span>؟
          </h2>
