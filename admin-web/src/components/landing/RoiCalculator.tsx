...
export function RoiCalculator() {
  ...
  const [sheetPrice, setSheetPrice] = useState(4000);
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 sm:gap-8 items-center">
            ...
            <div className="md:col-span-6 space-y-4">
              <div>
                <div className="flex justify-between items-center mb-1.5">
                  <label htmlFor="roi-clients" className="text-xs font-semibold text-white">زبائن صور الهوية يومياً</label>
            ...
            <div className="md:col-span-6 grid grid-cols-2 gap-3.5">
              <div className="p-4 rounded-xl bg-[#141414] border border-[#2C2C2C] flex flex-col justify-between">
                ...
                <span className="text-[10px] text-[#9E9E9E] mt-1">تفرّغ لأعمال أكثر</span>
              </div>
              ...
              <div className="p-4 rounded-xl bg-[#141414] border border-[#2C2C2C] flex flex-col justify-between">
                ...
                <span className="text-[10px] text-[#9E9E9E] mt-1">من توفير الورق</span>
              </div>
            </div>
          </div>
