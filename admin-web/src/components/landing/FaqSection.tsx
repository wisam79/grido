...
const FAQ_ITEMS = [
  {
    ...
    a: 'نعم! جميع الوظائف الأساسية — القص، التوسيط، توزيع الشبكات، الطباعة، وتصدير CMYK — تعمل محلياً 100% على جهازك. الإنترنت مطلوب فقط عند استخدام ميزات ترميم الوجوه بالذكاء الاصطناعي (CodeFormer) لأنها تعمل على خوادم معالجة متخصصة.',
  },
  {
  ...
  },
  {
    ...
    a: 'إطلاقاً في الوضع المحلي. كل المعالجة تتم على جهازك مباشرة. وعند استخدام ترميم AI الاختياري، تُرسل الصورة مشفّرةً مباشرة إلى خادم المعالجة لحظياً ولا تُخزَّن نهائياً — خصوصية زبائنك مضمونة بالكامل.',
  },
];
