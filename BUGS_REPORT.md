...
>
> **تصحيح ثانٍ (2026-09-18 — تحقق أسطر فعلي):** البنود التالية في هذا التقرير **غير صحيحة حالياً** ولا يجوز العمل عليها:
> - **الكتابة الذرية:** مُطبَّقة فعلاً في `media_service.go:448` و`window_state.go:51` (`utils.AtomicWriteFile`) وفي `print_export.go:90-100` (`utils.CreateAtomic`) — عكس ما ورد في جدول الثوابت §1.
