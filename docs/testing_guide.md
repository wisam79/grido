...
- **Playwright E2E:** **15 ملف مواصفة** يضم **31 سيناريو تفاعلي متكامل** تجتاز بنجاح تام على بيئة Wails v3 Mock Bridge، متضمنةً اختبارات كفاءة الكانفاس وسرعة السحب بـ 60 إطاراً في الثانية.
