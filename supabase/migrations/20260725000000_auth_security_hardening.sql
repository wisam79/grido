-- =================================================================================
-- Migration: 20260725000000_auth_security_hardening.sql
-- Goal: Fix ensure_profile_exists unnecessary updates and handle email conflicts
...
EXCEPTION WHEN unique_violation THEN
  -- Ignore the unique violation on email
  RETURN new;
END;
