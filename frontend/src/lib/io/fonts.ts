...
export const ARABIC_FONTS: FontOption[] = [
  ...
  { id: "inter", name: "إنتر (Inter - Modern)", family: "Inter, sans-serif", category: "sans-serif" },
  { id: "outfit", name: "أوتفت (Outfit - Geometric)", family: "Outfit, sans-serif", category: "sans-serif" },
  { id: "montserrat", name: "مونتسيرات (Montserrat - Bold)", family: "Montserrat, sans-serif", category: "sans-serif" },
  { id: "playfair", name: "بليفيل (Playfair - Elegant Serif)", family: "\"Playfair Display\", serif", category: "serif" },
];
