...
export const DocumentListItem: React.FC<DocumentListItemProps> = ({
  ...
  return (
    <div
      ...
      className={cn(
        "h-8 px-2 flex items-center justify-between rounded-md cursor-pointer transition-all border text-xs select-none group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background",
        isActive
