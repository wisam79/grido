 ...
 *
 * تُستخدم داخل Popover (وليس Dialog) في الشريط الجانبي — لا تُضَف نسخة
 * Dialog هنا: نسختان للوحة الأوامر خرق لثابت «حظر ازدواجية الميزات»
 * (.agents/AGENTS.md)، وموضع اللوحة الوحيد هو WorkspacePanelRail.
 */
